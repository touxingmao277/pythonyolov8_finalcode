...
class Keypoint:
    ...
    属性:
        ...
        name: 关键点名称 (如 nose, left_shoulder 等)
        x: 关键点在图像中的横坐标
        y: 关键点在图像中的纵坐标
        confidence: 关键点检测置信度 (0-1)
    """
    id: int
    name: str
    x: float
...
class PoseDetector:
    def __init__(
        ...
        参数:
            model_name: YOLOv8模型文件名，支持 yolov8n-pose, yolov8s-pose, yolov8m-pose 等
            conf_threshold: 关键点检测置信度阈值，低于此值的关键点将被忽略
